...
export function About() {
  return (
    <Flex align="center" justify="center" mih="100vh" id="about" bg="#659499" direction="column">
      ...
      <Text maw={700} size="1.5rem" align="center" p={10}>
        ...
        also incredibly delicious. The unique flavors of our cuisine, combined with the breathtaking
        views of the Adriatic Sea, make for an experience that will leave a lasting impression on
        your taste buds and your memory.
      </Text>
    </Flex>
  );
}
